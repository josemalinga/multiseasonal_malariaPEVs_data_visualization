...
data_set <- read.csv(paste0(getwd(),"/Fig5/data_multiseasonal_Tradeoffs.csv"))
...
data_set <- readRDS(paste0(getwd(),"/Fig5/data_multiseasonal_Reduction.rds"))
...
data_set <- readRDS(paste0(getwd(),"/Fig5/data_multiseasonal_Sensitivity.rds"))
